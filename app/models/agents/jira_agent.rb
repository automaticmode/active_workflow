...
module Agents
  class JiraAgent < Agent
    ...
    description <<-MD
      ...
      The agent does periodic queries and emits the messages containing the updated issues in JSON format.
    ...
    message_description <<-MD
      Messages are the raw JSON generated by Jira REST API
